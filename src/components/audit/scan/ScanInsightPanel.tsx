...
export default function ScanInsightPanel({
  ...
  return (
    <div
      className="rounded-2xl border border-primary-200/60 bg-gradient-to-br from-primary-50/60 to-white p-5 shadow-sm"
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-sm font-bold text-primary-800">AI Insight</h3>
      </div>

      <p className="mt-3 text-sm leading-relaxed text-slate-600">
        {displayedText}
        {displayedText.length < insight.length && (
          <span className="inline-block h-4 w-0.5 animate-pulse bg-primary-400 align-text-bottom" />
        )}
      </p>
